...
def run(date):
    moonpath = "data/moon_data/moon.png" #Input (full moon) image file path
    phasepath = "data/moon_data/phase.png" #Output image file path
    textpath = "data/moon_data/moon.txt" # Output text file path
    m = ephem.Moon(ephem.date(date))
    s = ephem.Sun(ephem.date(date))
    m.compute(ephem.date(date))
    s.compute(ephem.date(date))
    ...
    a = m.elong
    dt = ephem.next_full_moon(ephem.date(date))
